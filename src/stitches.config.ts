...
const globalTokens = {
  colors: {
    ...
    green500: 'var(--green, #22c55e)',
    green100: 'var(--green-100, #dcfce7)',
...
export const {
  ...
  theme: {
    ...
    colors: {
      ...
      dangerBg: globalTokens.colors.red100,
      successFg: globalTokens.colors.green500,
      successBgEmphasis: globalTokens.colors.green500,
      successBg: globalTokens.colors.green100,
