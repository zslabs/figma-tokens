...
// dist/useFigmaTokens.js
var require_useFigmaTokens = __commonJS({
  "dist/useFigmaTokens.js"(exports2, module2) {
    module2.exports = function(t) {
      ...
      function u(t2) {
        switch (t2) {
          ...
          case "border":
            return o.BORDER;
          case "borderRadius":
            return o.BORDER_RADIUS;
          case "borderWidth":
            return o.BORDER_WIDTH;
          case "opacity":
            return o.OPACITY;
          case "fontFamilies":
            return o.FONT_FAMILIES;
          case "fontWeights":
            return o.FONT_WEIGHTS;
          case "fontSizes":
            return o.FONT_SIZES;
          case "lineHeights":
            return o.LINE_HEIGHTS;
          case "typography":
            return o.TYPOGRAPHY;
          case "letterSpacing":
            return o.LETTER_SPACING;
          case "paragraphSpacing":
            return o.PARAGRAPH_SPACING;
          case "composition":
      ...
      function p(t2) {
        var e2 = !!t2.type && t2.type !== o.UNDEFINED ? t2.type : u(t2.name.split(".").slice(0, 1).toString());
        return s(s({}, t2), {}, { type: e2 });
      }
      function c(t2, e2, r2) {
        return Math.min(Math.max(t2, r2), e2);
      }
      !function(t2) {
        t2.OTHER = "other", t2.COLOR = "color", t2.IMPLICIT = "implicit", t2.BORDER_RADIUS = "borderRadius", t2.SIZING = "sizing", t2.SPACING = "spacing", t2.TEXT = "text", t2.TYPOGRAPHY = "typography", t2.OPACITY = "opacity", t2.BORDER_WIDTH = "borderWidth", t2.BOX_SHADOW = "boxShadow", t2.FONT_FAMILIES = "fontFamilies", t2.FONT_WEIGHTS = "fontWeights", t2.LINE_HEIGHTS = "lineHeights", t2.FONT_SIZES = "fontSizes", t2.LETTER_SPACING = "letterSpacing", t2.PARAGRAPH_SPACING = "paragraphSpacing", t2.TEXT_DECORATION = "textDecoration", t2.TEXT_CASE = "textCase", t2.COMPOSITION = "composition", t2.BORDER = "border", t2.UNDEFINED = "undefined";
      }(o || (o = {}));
      ...
      function l(t2) {
        ...
        if (t2.trim().toLowerCase() === "transparent")
          return [0, 0, 0, 0];
        let e2 = t2.trim();
        e2 = O.test(t2) ? function(t3) {
          const e3 = t3.toLowerCase().trim(), r3 = y[function(t4) {
        ...
        if (r2) {
          ...
          return [...t3.slice(0, 3).map((t4) => parseInt(v(t4, 2), 16)), parseInt(v(t3[3] || "f", 2), 16) / 255];
        }
        const n2 = d.exec(e2);
        if (n2) {
      ...
      const f = (t2) => parseInt(t2.replace(/_/g, ""), 36), y = "1q29ehhb 1n09sgk7 1kl1ekf_ _yl4zsno 16z9eiv3 1p29lhp8 _bd9zg04 17u0____ _iw9zhe5 _to73___ _r45e31e _7l6g016 _jh8ouiv _zn3qba8 1jy4zshs 11u87k0u 1ro9yvyo 1aj3xael 1gz9zjz0 _3w8l4xo 1bf1ekf_ _ke3v___ _4rrkb__ 13j776yz _646mbhl _nrjr4__ _le6mbhl 1n37ehkb _m75f91n _qj3bzfz 1939yygw 11i5z6x8 _1k5f8xs 1509441m 15t5lwgf _ae2th1n _tg1ugcv 1lp1ugcv 16e14up_ _h55rw7n _ny9yavn _7a11xb_ 1ih442g9 _pv442g9 1mv16xof 14e6y7tu 1oo9zkds 17d1cisi _4v9y70f _y98m8kc 1019pq0v 12o9zda8 _348j4f4 1et50i2o _8epa8__ _ts6senj 1o350i2o 1mi9eiuo 1259yrp0 1ln80gnw _632xcoy 1cn9zldc _f29edu4 1n490c8q _9f9ziet 1b94vk74 _m49zkct 1kz6s73a 1eu9dtog _q58s1rz 1dy9sjiq __u89jo3 _aj5nkwg _ld89jo3 13h9z6wx _qa9z2ii _l119xgq _bs5arju 1hj4nwk9 1qt4nwk9 1ge6wau6 14j9zlcw 11p1edc_ _ms1zcxe _439shk6 _jt9y70f _754zsow 1la40eju _oq5p___ _x279qkz 1fa5r3rv _yd2d9ip _424tcku _8y1di2_ _zi2uabw _yy7rn9h 12yz980_ __39ljp6 1b59zg0x _n39zfzp 1fy9zest _b33k___ _hp9wq92 1il50hz4 _io472ub _lj9z3eo 19z9ykg0 _8t8iu3a 12b9bl4a 1ak5yw0o _896v4ku _tb8k8lv _s59zi6t _c09ze0p 1lg80oqn 1id9z8wb _238nba5 1kq6wgdi _154zssg _tn3zk49 _da9y6tc 1sg7cv4f _r12jvtt 1gq5fmkz 1cs9rvci _lp9jn1c _xw1tdnb 13f9zje6 16f6973h _vo7ir40 _bt5arjf _rc45e4t _hr4e100 10v4e100 _hc9zke2 _w91egv_ _sj2r1kk 13c87yx8 _vqpds__ _ni8ggk8 _tj9yqfb 1ia2j4r4 _7x9b10u 1fc9ld4j 1eq9zldr _5j9lhpx _ez9zl6o _md61fzm".split(" ").reduce((t2, e2) => {
        ...
        const c2 = n2 - i2 / 2;
        return [a2 + c2, u2 + c2, p2 + c2].map(w);
      };
      function E(t2) {
        const [e2, r2, n2, o2] = l(t2);
        let i2 = (t3) => {
          const e3 = c(0, 255, t3).toString(16);
        ...
        try {
          ...
          try {
            ...
            o2.length > 0 && o2.forEach(function(t3) {
              r2 = r2.replace(t3, E(t3));
            }), n2.length > 0 && n2.forEach(function(t3) {
              var n3, o3, i2, s2 = t3, a2 = t3.replace(/rgba?\(/g, "").replace(")", ""), u2 = a2.match(e2), p2 = "1";
              if (u2) {
                var c2, h2, f2 = x(l(u2[0]), 3);
                n3 = f2[0], o3 = f2[1], i2 = f2[2], p2 = (c2 = (h2 = a2.split(",").pop()) === null || h2 === void 0 ? void 0 : h2.trim()) !== null && c2 !== void 0 ? c2 : "0";
              } else {
                var y2 = x(a2.split(",").map(function(t4) {
                  return t4.trim();
                }), 4);
              ...
              r2 = r2.split(s2).join(E("rgba(".concat(n3, ", ").concat(o3, ", ").concat(i2, ", ").concat(b2, ")")));
            });
          } catch (e3) {
      ...
      var S, T = /(\$[^\s,]+\w)|({([^]*))/g, k = /(\$[^\s,]+\w)|({([^}]*)})/g, I = function(t2) {
      ...
      !function(t2) {
        t2.sizing = "sizing", t2.height = "height", t2.width = "width", t2.spacing = "spacing", t2.verticalPadding = "verticalPadding", t2.horizontalPadding = "horizontalPadding", t2.paddingTop = "paddingTop", t2.paddingRight = "paddingRight", t2.paddingBottom = "paddingBottom", t2.paddingLeft = "paddingLeft", t2.itemSpacing = "itemSpacing", t2.fill = "fill", t2.border = "border", t2.borderRadius = "borderRadius", t2.borderRadiusTopLeft = "borderRadiusTopLeft", t2.borderRadiusTopRight = "borderRadiusTopRight", t2.borderRadiusBottomRight = "borderRadiusBottomRight", t2.borderRadiusBottomLeft = "borderRadiusBottomLeft", t2.borderWidth = "borderWidth", t2.boxShadow = "boxShadow", t2.opacity = "opacity", t2.fontFamilies = "fontFamilies", t2.fontWeights = "fontWeights", t2.fontSizes = "fontSizes", t2.lineHeights = "lineHeights", t2.typography = "typography", t2.composition = "composition", t2.letterSpacing = "letterSpacing", t2.paragraphSpacing = "paragraphSpacing", t2.textCase = "textCase", t2.textDecoration = "textDecoration", t2.tokenValue = "tokenValue", t2.value = "value", t2.tokenName = "tokenName", t2.description = "description";
      }(S || (S = {}));
      ...
      function se(t2) {
        return ie(t2) !== "object" || ie(t2.value) !== "object" || (t2 == null ? void 0 : t2.type) !== o.BOX_SHADOW && (t2 == null ? void 0 : t2.type) !== o.TYPOGRAPHY ? P(t2) ? t2.value.toString() : t2.toString() : t2.value;
      }
      ...
      function ue(t2) {
        ...
        try {
          ...
          if (r2) {
            ...
            if (!i2) {
              var s2 = oe(r2);
              return typeof s2 == "number" ? s2 : _(s2);
            }
          }
        } catch (r3) {
        ...
        return t2.filter(function(e2) {
          return function(t3) {
            ...
            try {
              ...
              else if (t3.type === o.TYPOGRAPHY || t3.type === o.BOX_SHADOW)
      ...
      function we(t2, e2) {
        return function t3(e3) {
          var r2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, i2 = ge(e3), s2 = e3;
          return s2 = e3.map(function(t4, e4, r3) {
            var i3, s3 = false;
            return t4.type === o.TYPOGRAPHY || t4.type === o.BOX_SHADOW ? typeof t4.value == "string" ? (i3 = ue(t4.value, r3), s3 = i3 === null || ce(i3)) : i3 = Array.isArray(t4.value) ? t4.value.map(function(t5) {
              return Object.entries(t5).reduce(function(t6, e5) {
                var n2 = ye(e5, 2), o2 = n2[0], i4 = n2[1];
                return t6[o2] = ue(i4, r3), (t6[o2] === null || ce(t6[o2])) && (s3 = true), t6;
              }, {});
            }) : Object.entries(t4.value).reduce(function(t5, e5) {
              var n2 = ye(e5, 2), o2 = n2[0], i4 = n2[1];
              return t5[o2] = ue(i4, r3), (t5[o2] === null || ce(t5[o2])) && (s3 = true), t5;
            }, {}) : t4.type === o.COMPOSITION ? i3 = Array.isArray(t4.value) ? t4.value.map(function(t5) {
              return { property: t5.property, value: ue(t5.value, r3) };
            }) : { property: t4.value.property, value: ue(t4.value.value, r3) } : (i3 = ue(t4, r3), s3 = i3 === null || ce(i3)), le(le({}, n(t4, "failedToResolve")), {}, { value: i3, rawValue: t4.rawValue || t4.value }, s3 ? { failedToResolve: s3 } : {});
          }), i2.length > 0 && (r2 > i2.length || !r2) ? t3(s2, i2.length) : s2;
        }(function(t3) {
          ...
          return Object.entries(t3).reverse().forEach(function(t4) {
            (n2.length === 0 || n2.includes(t4[0])) && t4[1].forEach(function(e4) {
              ...
              }) || r2.push(le(le({}, p(e4)), {}, { internal__Parent: t4[0] }));
            });
          }), r2;
        }(t2, function(t3) {
